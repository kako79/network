...
data_only_transfers = data.loc[data['admAge'] > 18].drop(['depname','evttype','effective_time', 'specialty', 'admAge', 'asa_rating_c', 'transfer', 'transfer_time', 'admission_time', 'discharge time'], axis=1)
