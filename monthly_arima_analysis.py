...
monthly_arima_df['bedsfree'] = monthly_arima_df['Total Occupied'].map(get_free_beds)
...
monthly_arima_df.to_csv('monthly_arima_noweekday_nov8.csv', header=True, index=False)
