...
edge_weight_data.to_csv('edge_all_adult2211.csv', header=True, index=False)
...
nx.write_pajek(G, 'pajek_adult_all_cat.net')
...
degrees_data.to_csv('degrees_all_adult.csv', header =True, index=False)
...
all_network_info_df.to_csv('adult_all_network_info.csv', header=True, index=False)
