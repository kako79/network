...
all_network_info_df.to_csv('info_gensurg_cat0612.csv', header=True, index=False)
edge_weight_data.to_csv('edge_gensurg_cat0612.csv', header=True, index=False)
nx.write_pajek(G, 'pajek_gensurg_cat0612.net')
degrees_data.to_csv('degrees_gensurg_cat0612.csv', header =True, index=False)
clustering_data.to_csv('clustering_gensurg_cat0612.csv', header = True, index = False)
nx.write_graphml(G,'graphml_gensurg_cat0612.graphml')
nx.write_gexf(G,'gexf_gensurg_cat0612.gexf')
